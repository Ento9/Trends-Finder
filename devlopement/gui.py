...
def dataCA():
    ...
    textbox2.insert(tk.INSERT, contenu)
...
label4 = tk.Label(root, text="Last Analyse:")
label4.grid(row=7, column=1)

textbox2 = tk.Text(root, font=('Arial', 15), width=30, height=1)
textbox2.grid(row=8, column=1)
